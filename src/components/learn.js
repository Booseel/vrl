    ...
    <section id="how_to_learn" className="bg_gradient_primary flex column">
      ...
      <div className="how_to_learn_content flex">
        <div className="illustration">
          <img src={require('../assets/img/head_ill.png')} className="head_ill" alt="head" />
          <img src={require('../assets/img/hands_ill.png')} className="hands_ill" alt="hands" />
        </div>
        <div className="how_to_learn flex column flex_align_center">
          <div className="how_to_learn_part blur flex flex_align_center">
            <img src={require('../assets/img/pay.png')} className="how_to_learn_icon" alt="pay" />
          ...
          <div className="how_to_learn_part blur flex flex_align_center">
            <img src={require('../assets/img/login.png')} className="how_to_learn_icon" alt="login" />
            <div className="learn_description">
          ...
          <div className="how_to_learn_part blur flex flex_align_center">
            <img src={require('../assets/img/education.png')} className="how_to_learn_icon" alt="education" />
            <div className="learn_description">              
              <h6>Обучение</h6>
          ...
          <div className="how_to_learn_part blur flex flex_align_center">
            <img src={require('../assets/img/user.png')} className="how_to_learn_icon" alt="user" />
            <div className="learn_description">              
          ...
          <div className="how_to_learn_part blur flex flex_align_center">
            <img src={require('../assets/img/gift.png')} className="how_to_learn_icon" alt="gift" />
            <div className="learn_description">                
      ...
      <img src={require('../assets/img/cloud.png')} className="cloud_ill" alt="cloud ill" />
    </section>
)
