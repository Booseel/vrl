        ...
        <div className="contact_info flex spc_arnd flex_align_center">
            ...
            <div className="flex column flex_align_center justify_center">
                ...
                <div className="info_social flex spc_arnd flex_align_center">
                    <a href="https://t.me/veca_rony"><img src='/telegram.svg' className="social_icon" alt="telegram" /></a>
                    <a href="https://www.instagram.com/veca_rony/"><img src='/instagram.svg' className="social_icon" alt="insta" /></a>
                    <a href="https://vm.tiktok.com/ZSvC6gEA/"><img src='/tiktok.svg' className="social_icon" alt="tiktok" /></a>
                </div>
            </div>
        </div>
    </div>
